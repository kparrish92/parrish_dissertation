...
```{r, 'eng-part-two', echo=FALSE, fig.cap= "Credible intervals of all plausible values of VOT as a function of Language for participant 492828"}
knitr::include_graphics(here("sections", "figs", "e_492828.png"))
```
...
```{r, 'vod-mod', echo=FALSE, fig.cap="95% credible intervals of all plausible values of VOT as a function of Language"}
knitr::include_graphics(here("sections", "figs", "vot_mod.png"))
```

# Discussion 

These results replicated previous work [@parrish_production_2022f], which found that L3 French VOT was intermediate of L1 and L2 VOT when those languages are Spanish and English.
...
The longitudinal design can establish not only that an L3 segment is produced or perceived accurately, but also that this accuracy is maintained throughout time.
