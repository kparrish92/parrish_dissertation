...
The results of Chapter 5 support the original SLM, but not the SLM-R.
Additionally, like the PAM and PAM-L2 , the SLM and SLM-R do not make explicit conditions for L3 learning. 
...
Future research should be open to all potential explanations and draw insights from other focuses within linguistics or other closely related fields.
