...
source(here::here("scripts", "final_data_collection_pct", 
                  "00_libs.R"))
source(here::here("scripts", "final_data_collection_pct", 
                  "03_load_data.R"))
...
report_df = read.csv(here("scripts", "final_data_collection_pct", 
               "data", "tidy",
...
report_df %>% 
  ...
  ggtitle("English L1: Probability of choosing an English word") + 
  ggsave(here("scripts", "final_data_collection_pct", "eng_l1_prob.png"))
